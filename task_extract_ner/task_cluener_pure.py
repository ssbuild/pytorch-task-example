...
class NN_DataHelper(DataHelper):
    ...
    def collate_fn(self,batch):
        ...
        o['spans'] = spans
        o['spans_mask'] = spans_mask
        if has_label:
            o['labels'] = labels
        return o


class MyTransformer(TransformerForPure, with_pl=True):
...
if __name__ == '__main__':
    ...
    dataHelper = NN_DataHelper(model_args, training_args, data_args,max_span_length=puremodel_args.max_span_length)
